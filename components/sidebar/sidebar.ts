...
angular.module('cofactrApp')
    .controller('SidebarController', function($scope: any, $location: any, $rootScope: any) {
        ...
        $scope.closeSidebar = function(): void {
            $scope.sidebarVisible = false;
            $rootScope.$broadcast('toggleSidebar', false);
        };
        
        // Set active item when clicked
        $scope.setActiveItem = function(path: string): void {
        ...
        $scope.onSearch = function(query: string): void {
