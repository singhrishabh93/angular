...
angular.module('cofactrApp')
    .controller('HeaderController', function($scope: any, $rootScope: any, $window: any) {
        ...
        $scope.checkMobile = function(): void {
        ...
        $scope.toggleSidebar = function(): void {
        ...
        // Open messages
        $scope.openMessages = function(): void {
        ...
        // Open notifications
        $scope.openNotifications = function(): void {
        ...
        // Toggle user menu
        $scope.toggleUserMenu = function(): void {
        ...
        // User menu actions
        $scope.viewProfile = function(): void {
            console.log('Viewing profile...');
            $scope.showUserMenu = false;
            $rootScope.$broadcast('viewProfile');
        };
        
        $scope.openSettings = function(): void {
        ...
        $scope.$on('pageTitleChanged', function(event: any, title: string) {
            $scope.pageTitle = title;
        });
        
        // Listen for notification updates
        $scope.$on('updateNotifications', function(event: any, data: any) {
        ...
        angular.element(document).bind('click', function(event: any) {
